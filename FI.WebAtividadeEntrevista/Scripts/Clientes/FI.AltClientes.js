...
$(document).ready(function () {
    if (obj) {
        obj.beneficiarios.forEach(mostraBeneficiarios);
...
function mostraBeneficiarios(item) {
    $('#tableBeneficiarios').append("<tr><td class='cpf'>" + item.CPFBeneficiario + "</td><td class='nome'>" + item.NomeBeneficiario + "</td><td><span class='table-edit'><button type='button' class='btn btn-warning'>Editar</button></span>     <span class='table-remove'><button type='button' class='btn btn-danger'>Excluir</button></span></td></tr>");
}
