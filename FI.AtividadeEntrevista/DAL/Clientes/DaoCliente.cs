...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            try
            {
                foreach (Beneficiarios beneficiario in cliente.beneficiarios)
                {
                    List<System.Data.SqlClient.SqlParameter> insertBeneficiarios = new List<System.Data.SqlClient.SqlParameter>();
                    insertBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("CPF", beneficiario.CPFBeneficiario));
                    insertBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("NOME", beneficiario.NomeBeneficiario));
                    insertBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", ds.Tables[0].Rows[0][0]));
                    DataSet insertingBenefs = base.Consultar("FI_SP_IncBenef", insertBeneficiarios);
                }
            }
            catch (Exception e)
            {
                Console.WriteLine("Erro ao incluir beneficiarios" + e);
            }
            long ret = 0;
        ...
        internal void Alterar(DML.Cliente cliente)
        {
            ...
            List<System.Data.SqlClient.SqlParameter> parametrosDelete = new List<System.Data.SqlClient.SqlParameter>();
            parametrosDelete.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", cliente.Id));
            base.Executar("FI_SP_DeleteBeneficiarios", parametrosDelete);
            ...
            try
            {
                foreach (Beneficiarios beneficiario in cliente.beneficiarios)
                {
                    ...
                    insertBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("CPF", beneficiario.CPFBeneficiario));
                    insertBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("NOME", beneficiario.NomeBeneficiario));
                    insertBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", cliente.Id));
                    DataSet insertingBenefs = base.Consultar("FI_SP_IncBenef", insertBeneficiarios);
                }
            }
            catch (Exception e)
